...
func (s *SnapshotEvidence) ApplyTxSimContext(txSimContext protocol.TxSimContext, runVmSuccess bool) (bool, int) {
	if s.delegate == nil {
		return false, -1
	}
	return s.delegate.ApplyTxSimContext(txSimContext, runVmSuccess)
}
