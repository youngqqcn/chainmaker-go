...
require (
	...
	chainmaker.org/chainmaker/consensus-tbft/v2 v2.0.0-20211215085939-e7942990801c
	...
	chainmaker.org/chainmaker/sdk-go/v2 v2.0.1-0.20211215090641-1c84fbecbe86
