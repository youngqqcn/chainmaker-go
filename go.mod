...
require (
	...
	chainmaker.org/chainmaker/consensus-maxbft/v2 v2.0.0-20211224070619-f552f199ff1e
	...
	chainmaker.org/chainmaker/vm-docker-go v0.0.0-20211220031950-78e251dd5ac4
